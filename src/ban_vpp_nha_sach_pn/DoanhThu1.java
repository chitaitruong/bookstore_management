 ...
 * @author ASUS
 */
public class DoanhThu1 extends javax.swing.JFrame {

    /**
     * Creates new form DoanhThu1
     */
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            loadDoanhThu2((int)jSpinner1.getValue(), dsVP.get((String)jComboBox1.getSelectedItem()));
            jLabel5.setText("DOANH THU THEO VP "+String.valueOf(jSpinner1.getValue()));
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Chart.ds=ds;
        Chart bd=new Chart();
        bd.setTitle(jLabel5.getText());
        bd.setTitleBD(jLabel5.getText());
        bd.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Chart.ds=ds;
        Chart bd=new Chart();
        bd.inBieuDo("anh_doanh_thu\\"+(jLabel5.getText()+new SimpleDateFormat("dd-MM-yyyy HH-mm-ss").format(new Date())).replace(" ", "_")+".jpg", 450, 400);
        System.err.println("anh_doanh_thu\\"+(new SimpleDateFormat("dd-MM-yyyy HH:mm").format(new Date()))+".png");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoanhThu1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadDoanhThu2(int nam,String mavpp){
        Vector column=new Vector();
        column.add("Mã VPP");column.add("Tháng 1");column.add("Tháng 2");column.add("Tháng 3");column.add("Tháng 4");column.add("Tháng 5");column.add("Tháng 6");column.add("Tháng 7");column.add("Tháng 8");column.add("Tháng 9");column.add("Tháng 10");column.add("Tháng 11");column.add("Tháng 12");column.add("Tổng doanh thu");
        ...
        try{
            ...
            if (mavpp.equals("all"))
            {
                String sql="{call DOANHTHUTHEONAM_VP(?,?,?)}";
                CallableStatement cstm = null;
                ResultSet rs=null;
                for (var x: dsVP.values())
                {
                    cstm=conn.prepareCall(sql);
                    cstm.setInt(1, (int)jSpinner1.getValue());
                    cstm.setString(2, (String)x);
                    cstm.registerOutParameter(3, java.sql.Types.BIGINT);
                    rs=cstm.executeQuery();
                    data.add((String)x);
                    while (rs.next())
                    {
                        data.add(rs.getLong("DOANHTHU"));
                    }
                    long tongDoanhThu=cstm.getLong(3);
                    data.add(tongDoanhThu);
                    dsData.add(data);
                    data=new Vector();
                }
                DefaultTableModel modelPer=(DefaultTableModel)jTable1.getModel();
                modelPer.setDataVector(dsData, column);
